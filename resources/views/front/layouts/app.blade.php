...
<head>
	...
	<title>JOBYFY | Find Best Jobs</title>
...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			<a class="navbar-brand" href="{{ route('home') }}"><span style="color:rgb(71, 224, 71)">JOBIFY.</span></a>
...
<div class="container">
    <p class="text-center text-white pt-3 fw-bold fs-6">© 2025 JOBYFY, all right reserved</p>
</div>
</footer> 
